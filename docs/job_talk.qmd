...
- Can we apply these methods in other high-frequency data sources? 
:::
...
- <span style="color:gray;">Can we apply these methods in other high-frequency data sources? </span>
...
curve_data %>% 
  ggplot(aes(t, beta)) + 
  geom_line(linewidth = 1.1, color = "#008767") +
...
::: {.incremental}
+ Changes in fingerprint (both walking and waveform) to predict changes in function
+ Designing real-time interventions based on arterial waveform during surgery
...
![](figs/qr_code_nourl.png){width=35%}
